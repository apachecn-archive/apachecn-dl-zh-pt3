...
![](assets/918516cc-0429-4221-a5e6-b4b6a07981f9.png)
...
![](assets/52a7de3c-2b87-45db-992b-18d3fa4cf1bc.png)

样本基因表达数据集

现在看看*图 3* 中的标签。这里，`id`包含样本 id，`Class`代表癌症标签:

![](assets/daf22379-e09a-4d38-bfde-7ef397fa9d83.png)
...
![](assets/afcd3570-cc02-41ad-b098-30f8d1fb93f5.png)
...
![](assets/76057702-d43e-4861-ac12-6a036a553a83.png)

**精度**是正确预测的正样本与总预测正样本的比率:

![](assets/1ebcd216-45df-45d1-a389-681ce465fa30.png)

**Recall** 是正确预测的阳性样本与实际类别中所有样本的比率—是:

![](assets/557e92fb-f546-40eb-8e6f-f24718421d69.png)

**F1 得分**是精度和召回率的加权平均值(调和平均值):

![](assets/a931ec3c-90b7-41a3-9800-5114b46a9dc2.png)

**马修斯相关系数** ( **MCC** )是二元(两类)分类质量的度量。MCC 可以直接从混淆矩阵计算如下(假设 TP、FP、TN 和 FN 已经可用):

![](assets/69ca053d-0119-46ca-b39e-722ed60ced3c.png)
...
![](assets/9d270be1-d0f0-4c68-b1c2-36f293e6f48b.png)
...
![](assets/3af96ada-3e47-48e5-a11b-9d22419e50a8.png)
...
![](assets/de957c74-8ffe-4f84-a18a-14e11aa94883.png)
...
![](assets/1fc7d7b2-006a-4aff-99c1-89e49f6facb1.png)
...
![](assets/21bcb1c3-96e4-41ff-b57f-6281f0e45715.png)
...
![](assets/2a036774-db9c-4e74-bbec-5e29b818ca01.png)
...
![](assets/184293ff-a744-4941-b1c5-8084d6786233.png)
...
![](assets/2cbc83a2-105b-4027-a354-c9bddef68089.png)

迭代过程中的 LSTM 模型得分

现在，另一个观察也值得一提。例如，梯度直到最后才消失，这从该图中变得更清楚:

![](assets/49b98b00-61ba-44dc-bb37-9622cb4545c3.png)

LSTM 网络在不同迭代中的梯度

最后，激活功能始终如一地发挥作用，这从下图中可以看得更清楚:

![](assets/5c7ef990-ef40-45d1-948f-343bfa31c34f.png)
