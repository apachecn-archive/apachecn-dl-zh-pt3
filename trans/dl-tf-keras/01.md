...
在本章中，我们学习了什么是 TensorFlow 和 Keras，并介绍了带有感知器和多层感知器的神经网络。然后，我们看到了一个经过多次优化的识别手写数字的真实例子。
