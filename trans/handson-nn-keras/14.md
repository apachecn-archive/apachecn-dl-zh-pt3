...
在本书的整个过程中，我们有幸一起探索了一个有趣的想法，这个想法充斥着并且目前主导着**人工智能** ( **AI** ): **人工神经网络** ( **ANNs** )。在我们的旅程中，我们有机会详细了解神经模型的功能，包括前馈、卷积和循环网络，从而**长期短期记忆** ( **LSTM** )。我们继续我们的旅程，随后探索自我监督的方法，包括使用深度 Q 网络的**强化学习** ( **RL** )以及自动编码器。我们通过回顾生成模型背后的直觉来结束我们的旅行。
